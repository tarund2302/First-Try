...
public class GoldFinder extends DogeCVDetector implements Constants {
     ...
     * Simple constructor
     */
    public GoldFinder(AutonomousOpMode auto, Hardware hardware) {
        super();
    ...
    public GoldFinder(Hardware hardware){
        super();
        detectorName = "Gold Finder"; //Set the detector name
        this.hardware = hardware;
        telemetry = hardware.telemetry;
